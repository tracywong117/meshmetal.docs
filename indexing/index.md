...
| **6. FAISS Index** | `index_mmap.bin build_low_mem` | Build 128-bit `IndexBinaryHash` index | `dataset.faiss` |

## Pipeline Execution Order

```
[Accession List] ──> [download_logan.py] ──> [.zst Contigs]
                                                   │
                                                   ▼
[mgdb_model.pt] ────> [gpus_inference_zstd.py] ──> [embeddings/*.bin]
                                                   │
                                                   ▼
                     [parallel_combine_sets_128] ──> [combined.bin]
                                                   │
                        ┌──────────────────────────┴──────────────────────────┐
                        ▼                                                     ▼
    [parallel_sd_vector_annotation_128]                              [index_mmap.bin]
                        │                                                     │
                        ▼                                                     ▼
              [annotations/*.bin]                                      [dataset.faiss]
                        │
                        ▼
                [construct_BRWT]
                        │
